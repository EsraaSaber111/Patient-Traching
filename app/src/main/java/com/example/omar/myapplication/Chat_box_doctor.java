...
public class Chat_box_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                while(true) {
                    try {
                        onSelect(String.valueOf(sharedprefmanger.getInstance(Chat_box_doctor.this).getId()),intent.getExtras().getString("id","1"));
                    }catch (Exception e){
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,   ServerDetails.sendMessage,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            Toast.makeText(Chat_box_doctor.this, "send success", Toast.LENGTH_SHORT).show();
                            //getMessage("1","2");
                            onSelect(String.valueOf(sharedprefmanger.getInstance(Chat_box_doctor.this).getId()),intent.getExtras().getString("id","1"));
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(Chat_box_doctor.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    map.put("id",  intent.getExtras().getString("id","1"));
                    map.put("idto",from_id);
    ...
    public void onSelect(final String from, final String to)
    {
        String serever_url = ServerDetails.getMessages;
        try {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, serever_url,
                ...
                @Override
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(Chat_box_doctor.this ,error.getMessage(),Toast.LENGTH_LONG).show();
